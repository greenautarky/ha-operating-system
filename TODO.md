...
### Release Sign-off / Freigabeprozess (Prio 1)
- [ ] Define release checklist, approval chain, rollback criteria
- [x] Changelog auto-generation — `scripts/generate-changelog.sh`
- See `ga-ihost-docs/RELEASING.md` for full workflow + diagram
