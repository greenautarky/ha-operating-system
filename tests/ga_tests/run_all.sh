...
SUITES_DEVICE="health telemetry network ping config_verify onboarding tailscale watchdog stress idle_perf hardware openstick ota_update"
SUITES_ALL="crash_detection health telemetry environment network ping boot_timing disk_guard watchdog config_verify stress idle_perf onboarding tailscale hardware openstick ota_update"
