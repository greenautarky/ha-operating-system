...
SUITES_EMU="environment crash_detection boot_timing disk_guard supervisor_health share_publish rauc_slots stage_components publish_services lte_standby"
